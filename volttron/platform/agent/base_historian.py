...
Historian a chance to setup any connections in the thread. This methoc can
...
class BaseHistorianAgent(Agent):
    ...
    def _do_process_loop(self):
        ...
        # should be called even for readonly as this might load the topic id name map
        ...
        while True:
            ...
            if self._setup_failed:
                # if the setup failed earlier, try again.
